...
X(xcb_get_extension_data, const struct xcb_query_extension_reply_t *, (xcb_connection_t *c, xcb_extension_t *ext))
...
X(xcb_get_selection_owner, xcb_get_selection_owner_cookie_t, (xcb_connection_t *c,xcb_atom_t        selection))
X(xcb_get_selection_owner_reply, xcb_get_selection_owner_reply_t *,(xcb_connection_t                  *c,xcb_get_selection_owner_cookie_t   cookie  /**< */,xcb_generic_error_t              **e))
X(xcb_convert_selection, xcb_void_cookie_t,  (xcb_connection_t *c,xcb_window_t      requestor,xcb_atom_t        selection,xcb_atom_t        target,xcb_atom_t        property,xcb_timestamp_t   time))
...
X(xcb_copy_area, xcb_void_cookie_t, (xcb_connection_t *c, xcb_drawable_t    src_drawable, xcb_drawable_t    dst_drawable, xcb_gcontext_t    gc, int16_t           src_x,int16_t           src_y,int16_t           dst_x,int16_t           dst_y,uint16_t          width,uint16_t          height))
X(xcb_copy_area_checked, xcb_void_cookie_t,(xcb_connection_t *c,xcb_drawable_t    src_drawable,xcb_drawable_t    dst_drawable,xcb_gcontext_t    gc,int16_t           src_x,int16_t           src_y,int16_t           dst_x,int16_t           dst_y,uint16_t          width,uint16_t          height))
X(xcb_poly_fill_rectangle, xcb_void_cookie_t,  (xcb_connection_t      *c, xcb_drawable_t         drawable,xcb_gcontext_t         gc,uint32_t               rectangles_len,const xcb_rectangle_t *rectangles))
X(xcb_configure_window, xcb_void_cookie_t,(xcb_connection_t *c,xcb_window_t      window,uint16_t          value_mask,const void       *value_list))
